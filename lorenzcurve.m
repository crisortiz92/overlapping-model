...
h = figure('Position', [150 100 700 450]);
...
xlabel('poorest population (%)', 'FontWeight', 'bold', 'FontSize', 16);
ylabel('wealth (%)', 'FontWeight', 'bold', 'FontSize', 16);

set(gca, 'FontWeight', 'bold', 'FontSize', 11, 'LineWidth', 1, 'Color', 'none', 'Box', 'on');
...
h2 = legend('Gini area','Perfect equality line (45º degree slope)','Uniform random distribution','Lorenz curve');
set(h2, 'FontSize', 8, 'Location', 'NorthWest', 'Box', 'off')

%set(gca, 'Position', [0.0915 0.1108 0.8832 0.8662])
set(gca, 'Position', [0.0050 0.250 1 0.7])
